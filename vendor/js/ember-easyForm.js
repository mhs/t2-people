...
(function() {
Ember.Handlebars.registerHelper('easy-input', function(property, options) {
  options = Ember.EasyForm.processOptions(property, options);
...
Ember.EasyForm.Input = Ember.EasyForm.BaseView.extend({
  ...
  canShowValidationError: true,
  showValidationError: function() {
    if (false && this.get('hasFocusedOut')) {
      if (Ember.isEmpty(this.get('context.errors.' + this.property))) {
        // NOTE: setting canShowValidationError to false here means that
        //       errors don't appear on a field until after you leave it
